...
{
    public class FEARFactory : IComponentFactory
    {
        private FEARComponent _instance;
        ...
        {
            get { return "Automates splitting and load removal for FEAR (Current Patch)."; }
        }
        ...
        public IComponent Create(LiveSplitState state)
        {
            ...
            return (_instance = new FEARComponent(state, createAsLayoutComponent));
        }
